...
"""
DEPRECATED: Profile view renderer has been moved.

This module is a compatibility shim. Import from the correct location:

    from saikei_civil.tool.profile_view_renderer import (
        ProfileViewRenderer,
        COLORS,
    )

Blender-specific GPU rendering code belongs in the tool/ layer (Layer 2),
