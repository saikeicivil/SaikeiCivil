...
Note: Moved from core/components/templates/operators.py to follow
three-layer architecture (operators belong in Layer 3, not Layer 1).
"""
...
from ..core.components.templates.registry import get_all_templates, list_templates
